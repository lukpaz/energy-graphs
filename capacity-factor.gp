...
stats datafile using 1:(100*$2*1000/$4/24/365) nooutput
max_y = STATS_max_y
...
plot datafile using 1:(100*$2*1000/$4/24/365) notitle with linespoints lt 3 lw 4 pt 7 linecolor rgb "blue"
